...
const {Travellers, Location, Trips} = require('../models');
...
const seedDatabase = async () => {
  ...
  console.log('######## puting in travelers ########');
  const travellers = await Travellers.bulkCreate(travellerSeedData);
  console.log('######## succesfully put travelers ########');

  console.log('######## puting in locations ########');
  const locations = await Location.bulkCreate(locationSeedData);
  console.log('######## succesfully put locations ########');
